...
export const envConfig = {
  ...
  STRIPE_SECRET: getEnvironmentVariable({
    ...
    testKey:
      "sk_test_51MXidpG859ZdyFmpVjbfa4cmXB4LxCbAOmGF2miuQhwYnPdvYKqKg7eojkplvixcd5tvQZTGShPwffzyzbILhoMZ00y45NdkRS",
  }),
  STRIPE_PUBLIC: getEnvironmentVariable({
    environmentVariable: "STRIPE_PUBLIC",
    testKey:
      "pk_test_51MXidpG859ZdyFmpulIyjBVw96vod2EQJOyhZHLxEvHe7y1GTuXryqMF1X9SbhKT1xla0o6w7XvNBh6IYFQULVch005S97qsEO",
  }),
  STRIPE_CHECKOUT_WEBHOOK: getEnvironmentVariable({
    environmentVariable: "STRIPE_CHECKOUT_WEBHOOK",
    testKey: "whsec_cdnwuLAIEQNpVEoxnqnO45WmuVFy3CWN",
  }),
  ...
  THIRDEYE_KEY: getEnvironmentVariable({
    environmentVariable: "THIRDEYE_KEY",
  }),
  THIRDEYE_SECRET: getEnvironmentVariable({
    environmentVariable: "THIRDEYE_SECRET",
  }),
  NO_REPLY_PASSWORD: getEnvironmentVariable({
    environmentVariable: "NO_REPLY_PASSWORD",
  }),
  SMTP_HOST: getEnvironmentVariable({
