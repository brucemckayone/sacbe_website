    ...
    () => (
      ...
      >
        ...
        <button
          ...
          className="self-center rounded-md px-2 py-1 border-2 border-black font-display"
        >
    ...
    <div className="w-full m-auto flex justify-center pb-10">
      <div className="w-11/12 md:w-8/12">
        <input
          ...
          className="text-onPrimaryContainer focus:outline-none text-4xl md:text-5xl border-b-2 border-black font-display placeholder:text-onPrimaryContainer self-center w-full bg-transparent m-auto px-5 pt-2 mt-10"
        />
