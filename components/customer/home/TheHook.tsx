...
import { GetOfferButton } from "../../shared/buttons/GetOfferButton.1";
...
export function CheckList(props: { benefits: string[] }) {
  const learnMoreUrl =
  ...
  return (
    <div className="ml-1 my-4 p-2 lg:w-2/3">
      ...
      <Link className="ml-6 mt-4" href={learnMoreUrl}>
        Learn More
      </Link>
    </div>
  );
      ...
      <div className="flex flex-col-reverse lg:flex-row w-[95%] md:w-10/12  px-2 md:px-10 m-auto py-5 md:mt-36 backdrop-blur-lg bg-primaryContainer/20 rounded-3xl">
        <div className="md:w-10/12 lg:w-7/12 m-auto">
          ...
          <CheckList
            benefits={[
              ...
              "Improved cardiovascular function and recovery",
              "Powerful Mood Enhancement",
              "Nervous system support", // Duplicate item removed
            ]}
          />
        ...
        <Card className="12 md:basis-1/2" hasColor={false}>
          ...
          <SlideInUp animiation="animate-zoom_in_fade">
            ...
            <h3 className="text-center border-black text-sm md:text-sm font-extrabold  backdrop-blur-2xl bg-onSecondary/20 border rounded-lg p-2  md:mx-20 z-50">
