...
const RiskApealCards = dynamic(() =>
  import("../shared/RiskApealCards").then((res) => res.RiskApealCards)
);
  ...
  function GenerateExtraDetails() {
    switch (selected) {
      case "customer":
        return (
          <div
            className="flex flex-col justify-between h-full animate-zoom_in_fade bg-surface rounded-xl p-3 drop-shadow-md"
      ...
      case "pricing":
        return (
          <div
            key={"pricing details"}
            className=" bg-surface rounded-xl p-3 drop-shadow-md animate-zoom_in_fade"
          >
      ...
      case "supply":
        return (
          <div
            className=" flex flex-col justify-between  bg-surface rounded-xl p-3 drop-shadow-md animate-zoom_in_fade"
            key={"supply details"}
          >
            <span>
