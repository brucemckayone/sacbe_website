...
export function NewsletterSignup() {
  ...
  return (
    <div className="w-full bg-tertiaryContainer border border-black m-auto flex justify-center pb-10 mt-10 rounded-lg drop-shadow-lg">
      <div className=" w-11/12 md:w-11/12">
        ...
        <input
          ...
          className="text-onPrimaryContainer focus:outline-none text-4xl placeholder:text-3xl md:text-5xl border-black border-b-2 font-display placeholder:text-onPrimaryContainer self-center w-full  bg-transparent m-auto  pt-2 mt-10"
        />
        <div className="flex justify-between mt-2">
          ...
          <button
            ...
            type="button"
            className="self-end rounded-md px-2 py-1 border-2 border-black font-display"
          >
