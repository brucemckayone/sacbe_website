  ...
  return (
    <li>
      <div
        ...
        className={`text-xl no-underline flex items-center p-2 text-onTertiaryContainer ${
          props.isSelected ? "bg-onPrimary" : "bg-primaryContainer"
        }  rounded-lg hover:bg-surface duration-300`}
      >
        <svg
          aria-hidden="true"
