...
export function PurchaseOptions(props: props) {
  ...
  return (
    ...
    >
      <div className=" md:h-[300px] flex flex-col justify-between text-onPrimary rounded-lg drop-shadow-lg border-2 border-[black] mt-2">
        ...
        <div className="flex h-full align-middle bg-surface p-2">
          ...
          <div className="flex-col justify-center ">
            <div className="ml-5 ">
              <ol className="list-disc ml-5 md:text-2xl">
