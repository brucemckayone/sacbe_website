...
export function RecipeCard(props: any) {
  return (
    <div className="py-5 border-primaryContainer border-b">
      <div className="drop-shadow-lg bg-surface duration-500 rounded-lg hover:shadow-lg hover:border-none border-b  ">
        <Link
          style={{
            textDecoration: "none",
          }}
        ...
        >
          <div className="">
            <div
              className="flex flex-col justify-between md:flex-row my-5  "
