...
export function QuickQuestion(props: {
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <div className={!props.question ? ` pt-10 pb-10 ` : ""}>
        {selectedAwnser ? (
          <div>
            ...
            <div className="flex flex-wrap bg-tertiaryContainer py-10">
              {results && !isLoading && (
                <div className="bg-surface border rounded p-5 w-11/12 md:w-[450px] m-auto">
                  <h6>Results</h6>
